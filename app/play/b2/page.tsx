...
export default function ModeB2Page() {
        ...
        <div className="max-w-2xl mx-auto">
          <Card className="p-6 mb-6 bg-purple-50 dark:bg-purple-500/10 border-2 border-purple-300 dark:border-purple-500/30">
            ...
            <p className="text-slate-700 dark:text-slate-300">
              아래 5개 국가를 <span className="font-bold text-purple-700 dark:text-purple-400">인구가 많은 순서대로</span> 드래그하여 정렬하세요.
            </p>
          </Card>
